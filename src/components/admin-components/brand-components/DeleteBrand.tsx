...
const DeleteBrand = ({children, brandId}: Props)=>{
    const category = brands.find((brand: { id: string; })=> brand.id === brandId)
    ...
    return (
        <>
            <Dialog open={openModel} onOpenChange={handleCloseModel}>
                ...
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Are you sure you want to delete Category {category?.name}?</DialogTitle>
                    </DialogHeader>
