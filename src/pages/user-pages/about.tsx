        ...
        <>
            <div>
                <div className={"inline-padding lg:mt-20 sm:mt-16 mt-6"}>
                    <h2 className={"text-5xl text-center md:text-left md:text-9xl text-[rgba(210,210,210,.7)] font-extrabold"}>Know
                        Us More</h2>
                    ...
                    <div className={"relative rounded-lg w-full"}>
                        ...
                        <div className={"absolute top-0 left-0 w-full h-full flex flex-col p-8 md:px-14 md:py-24"}>
                            <div className={"mt-auto"}>
                                <p className={"text-white sm:text-6xl text-2xl font-extrabold"}>Helping Your Keep
                                    Fit</p>
                                <p className={"text-white sm:text-4xl text-lg font-extrabold"}>Since 2016</p>
                            </div>
                        </div>
                    </div>
                    <div className={"grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-4 pt-10 pb-4 mt-10 md:mt-24"}>
                ...
                {/**/}
                <div
                    className={"inline-padding section bg-[#F2F4F6] pb-16 sm:pb-20 md:py-24 lg:pb-32 flex flex-col gap-8 mad:gap-10 lg:gap-14"}>
                    <h3 className={"sm:w-fit sm:mx-auto text-lg md:text-3xl font-extrabold"}>History</h3>
                    <h2 className={"w-fit mx-auto text-4xl md:text-6xl font-extrabold"}>Sed non mauris vitae erat consequat​</h2>
                    <p className={"sm:w-fit sm:mx-auto text-justify md:text-center max-w-[70rem]"}>There are many variations of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. Nam nec tellus a odio
                ...
                <div className={"grid md:grid-cols-3"}>
                    <div className={"relative max-h-[46rem] h-full"}>
                        <img className={"block w-full h-full object-cover"} src={speed}
                             alt={"Background Image"}/>
                        <div style={shadowBackground}
                             className={"absolute bg-bottom-shadow top-0 left-0 w-full h-full flex flex-col p-8 md:px-14 md:py-24"}>
                            <div className={"mt-auto"}>
                ...
                <div
                    ...
                    <p className={"sm:w-fit sm:mx-auto text-justify max-w-[45rem]"}>Nam nec tellus a odio
                        tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat auctor eu in elit. Class
                        aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in
                        erat justo. </p>
                    <Link to={"shop"}
