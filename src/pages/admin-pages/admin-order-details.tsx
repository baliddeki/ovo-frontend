        ...
        <>
            <div className={"vertical-spacing"}>
                <div className={"flex items-center justify-between gap-4"}>
                    <h2 className={"text-2xl font-bold"}>Orders #{orderId} Details</h2>
                    <div>
                        <Breadcrumb>
                            <BreadcrumbList>
                                <BreadcrumbItem>
                ...
                <div className={"grid lg:grid-cols-12 gap-4"}>
                    ...
                    <div className={'lg:col-span-4 vertical-spacing'}>
                        ...
                        <div className={"rounded-lg bg-white p-4 lg:col-span-4 vertical-spacing h-fit"}>
                            ...
                            <div className={"vertical-spacing"}>
                                <p>Payment Status</p>
                                <p className={"py-2 px-6 border rounded-lg"}>{order?.paymentStatus}</p>
                            </div>
                            <div className={"vertical-spacing"}>
                                <p>Order Status</p>
                                <p className={"py-2 px-6 border rounded-lg"}>{order?.status}</p>
                            </div>
                            <div className={"vertical-spacing"}>
                                <p>Delivery Status</p>
                                <p className={"py-2 px-6 border rounded-lg"}>{order?.deliveryStatus}</p>
                            </div>
                        </div>
                    </div>
