                            ...
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>Do not exceed 20 characters when entering the product name.</FormDescription>
                                        <FormMessage/>
                                    </FormItem>
                                )}
                            />
                            ...
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>Do not exceed 100 characters when entering the product name.</FormDescription>
                                        <FormMessage/>
                                    </FormItem>
                                )}
                            />
                        ...
                        <div className={"vertical-spacing gap-8 bg-white p-6 rounded-lg"}>
                            ...
                            <div className={"grid grid-cols-2 gap-4"}>
                                ...
                                <FormField
                                    ...
                                    render={({field}) => (
                                        <FormItem>
                                            <FormLabel className={"text-lg"}>Product Price <span className={"text-sm text-orange-5"}>*</span></FormLabel>
                                            <FormControl>
                                                <div className={"md:ml-2 border-[1px] rounded-lg px-4 py-2"}>
                                                    <Input
                                                        type={"number"}
                            ...
                            <button type={"submit"} className={"py-3 px-6 max-w-[9rem] w-full rounded-lg bg-blue-5 border-none text-white"}>Add Product</button>
                        </div>
                    </div>
                </form>
            </Form>
